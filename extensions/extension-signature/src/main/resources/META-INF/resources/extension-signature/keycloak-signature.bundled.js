 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */}var ot;null===(ot=window.HTMLSlotElement)||void 0===ot||ot.prototype.assignedElements;var at,lt,ht=((t,...e)=>{const s=1===t.length?t[0]:e.reduce(((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1]),t[0]);return new n(s,t,i)})`
  :host {
    display: block;
  }
...
`,ct=function(t,e,i,s){for(var n,r=arguments.length,o=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(o=(r<3?n(o):r>3?n(e,i,o):n(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o};!function(t){t.failed="failed",t.signed="signed",t.rejected="rejected"}(at||(at={})),function(t){t.authenticationFailed="authentication-failed",t.authenticationForbidden="authentication-forbidden",t.passwordEmpty="password-empty",t.unexpectedError="unexpected-error"}(lt||(lt={}));let dt=class extends it{constructor(){super(...arguments),this.signEndpoint="/realms/master/signature/sign",this.titleText="Keycloak Signature Extension",this.acceptText="Accept",this.rejectText="Reject",this.maxNrOfAuthAttempts=3,this.attemptIndex=1}render(){return this.payload?R`
      <div class="wrapper">
    ...
    `:(console.warn("No valid payload provided."),z)}async handleFormSubmit(t){t.preventDefault();const e=t.target,i=new FormData(e).get("password");if(this.attemptIndex>=this.maxNrOfAuthAttempts)this.maxNrOfAuthAttemptsExceeded(e);else if(i)try{const t=await this.makeSignRequest(i);if(t.ok){const e=await t.json();this.attemptIndex=this.maxNrOfAuthAttempts,this.createAndDispatchAcceptEvent(e)}else 403===t.status?(console.warn("Authentication failed (403).",this.attemptIndex),this.handleWrongPasswordEntered()):(console.error("Unexpected failure response received. "),this.handleUnexpectedFailureResponse())}catch(t){console.error("Error:",t),this.handleErrorDuringRequest()}finally{e.reset()}else this.noPasswordEntered(e)}makeSignRequest(t){const e=this.signEndpoint,i={payload:this.payload,credentials:{password:t}};return fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)})}handleResetButton(){this.dispatchEvent(new CustomEvent(at.rejected))}noPasswordEntered(t){console.error("No password given"),this.createAndDispatchFailureEvent(lt.passwordEmpty),t.reset()}maxNrOfAuthAttemptsExceeded(t){this.createAndDispatchFailureEvent(lt.authenticationForbidden),t.reset()}handleWrongPasswordEntered(){this.attemptIndex++,this.createAndDispatchFailureEvent(lt.authenticationFailed)}handleUnexpectedFailureResponse(){this.attemptIndex=this.maxNrOfAuthAttempts,this.createAndDispatchFailureEvent(lt.unexpectedError)}handleErrorDuringRequest(){this.attemptIndex=this.maxNrOfAuthAttempts,this.createAndDispatchFailureEvent(lt.unexpectedError)}createAndDispatchAcceptEvent({signedPayload:t}){this.dispatchEvent(new CustomEvent(at.signed,{detail:{signedPayload:t}}))}createAndDispatchFailureEvent(t){this.dispatchEvent(new CustomEvent(at.failed,{detail:{reason:t}}))}};dt.styles=ht,ct([rt()],dt.prototype,"signEndpoint",void 0),ct([rt({attribute:"payload",type:String})],dt.prototype,"payload",void 0),ct([rt({attribute:"title",type:String})],dt.prototype,"titleText",void 0),ct([rt({attribute:"accept",type:String})],dt.prototype,"acceptText",void 0),ct([rt({attribute:"reject",type:String})],dt.prototype,"rejectText",void 0),ct([rt({attribute:"max-nr-of-auth-attempts",type:Number})],dt.prototype,"maxNrOfAuthAttempts",void 0),dt=ct([(t=>e=>"function"==typeof e?((t,e)=>(customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(e){customElements.define(t,e)}}})(t,e))("keycloak-signature")],dt);export{dt as KeycloakSignature};
